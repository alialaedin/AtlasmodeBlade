<section v-for="category in showInHomeCategories" :key="category.id" class="most-saled d-flex flex-column gap-lg-4 gap-7 mt-12">
  <!-- Title -->
  <div class="d-flex align-items-center justify-content-between">
    <h2 class="h6-strong color-gray-900">@{{ category.title }}</h2>
    <a 
  ...
  <div class="swiper categories-products-swiper">
