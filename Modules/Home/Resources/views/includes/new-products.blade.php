...
<section class="most-saled d-flex flex-column gap-lg-6 gap-7 mt-12">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <h2 class="h4-strong color-gray-900">جدیدترین های اطلس</h2>
    <a 
      href="{{ route('front.products.index', ['sort' => 'newest']) }}" 
            ...
            <a href="{{ route('front.products.show', $product) }}" class="bg-gray-100 d-flex flex-column overflow-hidden position-relative">
              ...
              <figure class="product-img overflow-hidden position-relative">
                <img 
                  ...
                  loading="lazy" 
                  src="{{ asset('front-assets/images/homePage/product-5125-thumb_lg.jpg') }}" 
                  alt=""
                />
                <img 
                  class="hover-img w-p-100 h-p-100 hidden position-absolute top-0 start-0" 
                  loading="lazy" 
                  src="{{ asset('front-assets/images/homePage/product-5125-thumb_lg (1).jpg') }}" 
                  alt=""
                />
