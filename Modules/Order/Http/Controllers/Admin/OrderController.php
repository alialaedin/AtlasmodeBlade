...
class OrderController extends Controller
{
  ...
  public function deleteItem(OrderItem $orderItem)
  {
    ...
    try {
      ...
      $walletOperationData['name'] = $customer->full_name;
      $walletOperationData['mobile'] = $customer->mobile;
      $walletOperationData['description'] = "به دلیل حذف آیتم سفارش از سفارش به شناسه $order->id";

      $customer->deposit($calculateAmount, $walletOperationData);
